<?php 
   ...
   if(isset($_POST['add'])){
      ...
      $query = mysqli_query($con, "INSERT INTO donors VALUES ('', '$fname', '$lname', '$gender', '$date', '$email', '$donation', '$sessionid')");
      if($query) {
         $msg = "Data Inserted In Donors Successfully <br> Refreshing Web In <span>4</span> Seconds...";
      }
   }
?>
<!DOCTYPE html>
                  ...
                  <select name="donation" id="" required>
                     ...
                     <?php 
                        ...
                        while($fetch = mysqli_fetch_array($sql)){
                           ...
                           $optTxt = $fetch['Name'];
                     ?>
                        <option value="<?php echo $optId?>"><?php echo $optTxt?></option>
                     <?php } ?>
                  </select>
               </div>
