<?php 
   ...
   if(isset($_POST['filter'])){
      $from = $_POST['from'];
      $to = $_POST['to'];
      $sql = mysqli_query($con, "SELECT * FROM `donation` WHERE date BETWEEN '$from' AND '$to' ORDER BY date");
   }
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <main>
      ...
      <div class="main_data">
         ...
         <div class="data_div">
            ...
            <br>
            <a class="myBtns" href="addDonation.php">Add In Donations</a>
               ...
               <div class="data_table">
                  <table>
                     ...
                     <tr>
                        ...
                        <td><?php echo $fetchName?></td>
                        <td><?php echo $fetchDate?></td>
                        <td><?php echo $fetchType?></td>
                        <td><?php echo number_format($fetch['amount'],2,'.',',')." FRW ";?></td>
                        <?php if($loggedPrivilege == 2) { ?>
                           <td class="actions">
                              <button onclick="confirmDelete('./donations.php?delete=<?php echo $fetchID?>')"  class="myBtns deleteBtn">Delete</button>
                              <a class="myBtns" href="./upDonation.php?id=<?php echo $fetchID?>">Update</a>
                           </td>
                        <?php } ?>
                     </tr>
                     <?php } ?>
